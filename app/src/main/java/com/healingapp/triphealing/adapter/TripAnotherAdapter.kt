...
class TripAnotherAdapter(val itemList: ArrayList<ItemTripDetailRV>) :
    RecyclerView.Adapter<TripAnotherAdapter.BoardViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BoardViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_trip_another, parent, false)
